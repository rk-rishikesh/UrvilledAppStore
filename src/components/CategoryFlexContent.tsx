...
const CategoryFlexContent:React.FC<IHiglight> = ({ifExists,title,heading, img, url, text, btn}) => {
  return (
    <>
        ...
        lg:justify-center the-container ${!ifExists ? 'flex-row':'flex-row-reverse'}`}>
            ...
            <div className='flex items-center justify-center max-w-xl relative lg:max-w-none w-full'>
                <img src={img} alt={`img/${heading}`} 
                    ...
                    ${ifExists ? 'h-80 lg:h-56 md-h-52 sm:h-44 xsm:h-36 rotate-[34deg] hover:rotate-12'
...
export default CategoryFlexContent